...
#param_rand = {
#    'n_estimators': [120, 200, 300, 400, 500],
#    'max_depth': [20, 30, 40, 50],  
#    'min_samples_split': [2, 5, 10, 15],  
#    'min_samples_leaf': [1, 2, 4],  
#    'max_features': ['sqrt', 'log2', 15, 30]
#}
#
## RandomizedSearchCV
...
cm_display.plot()
plt.savefig('aug_cm_rf.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('aug_roc_rf.png', dpi=300, bbox_inches='tight')
plt.show()
